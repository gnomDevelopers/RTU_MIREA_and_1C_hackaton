<template>
    ...
    <div class="flex flex-col w-full lg:w-10/12 items-center gap-y-4 mb-4">
      ...
      <div class="flex flex-col lg:flex-row gap-4 w-full justify-center items-start">
        <div class="flex flex-col w-full lg:w-1/2 gap-y-4 p-4 rounded-xl bg-color-light">
          ...
          <div class="flex flex-col mb:flex-row gap-4 justify-center items-center">
            <div 
